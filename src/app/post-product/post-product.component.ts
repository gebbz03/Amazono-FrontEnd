        ...
        if (product.categoryId) {
          if (product.description) {
            if (product.product_picture) {
              ...
              Swal('Message!', 'Please select product image!', 'warning')
            }

          } else {
            Swal('Message!', 'Please enter description!', 'warning')
          }

        } else {
          Swal('Message!', 'Please select category', 'warning')
        }

      } else {

        Swal('Message!', 'Please enter a price!', 'warning')
      }

    } else {
      Swal('Message!', 'Please enter a title!', 'warning')
